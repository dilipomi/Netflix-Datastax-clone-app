...
✅ Register (if needed) and Sign In to Astra [https://astra.datastax.com](https://dtsx.io/3jEvJHg): You can use your `Github`, `Google` accounts or register with an `email`.
